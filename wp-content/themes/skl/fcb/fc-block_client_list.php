<?php 
 ...
 <section id="<?php echo $css_id; ?>" class="block block__<?php echo $bg_color; ?> block__clients <?php echo " $css_class"; ?><?php if($bg_tilt) { echo " $bg_tilt"; echo " $bg_tilt_dir"; } ?> block--align__<?php echo $frame_alignment; ?> clearfix" <?php if (! empty($bg_image)) { ?>style="background-image: url('<?php echo $bg_image[url]; ?>');" <?php } ?>>
 	<div class="frame frame__<?php echo $frame_position; ?> frame__<?php echo $frame_width; ?>">
 		<div class="inner-content">
			...
			<?php } ?>
 			...
 			<?php 
 				...
 				$posts = get_sub_field( 'client_list' );
 				if ( $posts ) : ?>
 				  ...
 				  <?php foreach ( $posts as $post) : // variable must be called $post (IMPORTANT) ?>
 				    ...
 				    ?>
 				    <li class="col-md-4 client-list--item"><img src="<?php echo $client_logo['url']; ?>" alt="<?php the_title(); ?>">
